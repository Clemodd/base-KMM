package specificitePlateforme
import com.russhwolf.settings.ObservableSettings
import com.russhwolf.settings.Settings
import com.russhwolf.settings.SettingsListener

/**
 * Classe qui encapsule la gestion des paramètres et des préférences de l'application.
 * Elle offre une interface pour stocker et récupérer des valeurs dans un espace de stockage spécifique à la plateforme
 * (SharedPreferences sur Android et UserDefaults sur iOS) dans un projet Kotlin Multiplatform (KMM) avec Compose.
 */
class StockageEnLocalRepositoryImpl(private val settings: Settings) : StockageEnLocalRepository {
...
interface StockageEnLocalRepository {
